...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-mer0vech.git;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# set to reference a specific commit hash in your assignment repo
SRCREV = "cb29376883dafeaba665689ee253a12276a43870"
...
do_install () {
  ...
  install -d ${D}${bindir}
  install 0d ${D}${sysconfdir}/init.d
